...
public class Constants {
	...
	//播放端错误信息
	public static final String ERROR_MSG_GROUP_NOT_EXIT =  LiveApplication.getInstance().getString(R.string.group_not_exit_error);
	public static final String ERROR_MSG_JOIN_GROUP_FAILED =  LiveApplication.getInstance().getString(R.string.join_group_error);
	public static final String ERROR_MSG_LIVE_STOPPED =  LiveApplication.getInstance().getString(R.string.live_stop_error);
	public static final String ERROR_MSG_NOT_QCLOUD_LINK =  LiveApplication.getInstance().getString(R.string.not_qcloud_link);
	public static final String ERROR_RTMP_PLAY_FAILED = LiveApplication.getInstance().getString(R.string.rtmp_play_error);
	public static final String TIPS_MSG_STOP_PUSH = LiveApplication.getInstance().getString(R.string.msg_stop_push_error);
